...
These are real photographs of Amanora Park Town supplied by Reliable Properties (not stock, no external license needed). They show the neighbourhood and building exteriors — not the interior of this specific unit.

- `amanora-dome-dusk.jpg` — Amanora Park Town at dusk (gallery main image)
- `amanora-skyline-day.jpg` — Amanora skyline, daytime
- `tower-facade-low-angle.jpg` — Tower facade, low angle (building exterior)
- `amanora-tower-night.jpg` — Amanora Park Town at night
